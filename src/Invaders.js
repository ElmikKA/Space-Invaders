...
export class Invaders {
    ...
    shootLaser() {
        const iLazer = new InvaderLaser(this.alienInvaders, this.currentShooterIndex, this.squares, this.width, this.aliveInvaders, this.alienInvadersCopy, this.laserSpeed, this.frequency)
        iLazer.fire()
        this.shooting = true
    }
}